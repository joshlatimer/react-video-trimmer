...
function (_PureComponent) {
  _inherits(DraggerContainer, _PureComponent);

  function DraggerContainer() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, DraggerContainer);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DraggerContainer)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "_owidth", null);

    _defineProperty(_assertThisInitialized(_this), "handleMouseDown", function (e) {
      _this._screenX = e.screenX;
      _this._screenY = e.screenY;
      _this._ox = _this.props.x;
      _this._owidth = _this.props.width;
...
_defineProperty(DraggerContainer, "defaultProps", {
  onDrag: function onDrag() {},
  x: 0,
  y: 0
});

_defineProperty(DraggerContainer, "propTypes", {
  x: PropTypes.number,
  y: PropTypes.number,
...
export { DraggerContainer as default };